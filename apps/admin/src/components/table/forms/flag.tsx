...
export function FlagForm() {
  ...
  return (
    <Card className="m-auto max-w-md">
      <CardHeader>
        <CardTitle className="text-2xl">Create Flag</CardTitle>
        <CardDescription>Create a new flag</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <FormLabel className="text-base">Ignore Case</FormLabel>
                  <FormControl>
                    <Switch
                      checked={field.value}
