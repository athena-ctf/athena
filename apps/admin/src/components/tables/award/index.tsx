...
export function AwardTable() {
  ...
  const onFileUpload = async (file: File) => {
    apiClient.POST("/admin/award/import", {
      body: {
        file,
      },
      bodySerializer: (body) => {
  ...
  return (
    <>
      <DataTable data={data} columns={columns} search="value" filters={[]} actions={actions} />
