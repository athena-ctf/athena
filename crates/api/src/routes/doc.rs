...
#[openapi(
    ...
    paths(
        ...
        notification::player_list_unread,
        permission::add_role_permissions,
        permission::add_override_permission,
        permission::remove_role_permissions,
        permission::remove_override_permission,
        permission::remove_role,
        permission::remove_override,
        player::list,
        player::list_ids,
        player::create,
...
fn to_method(value: utoipa::openapi::path::HttpMethod) -> axum::http::Method {
    match value {
        utoipa::openapi::HttpMethod::Get => axum::http::Method::GET,
        utoipa::openapi::HttpMethod::Post => axum::http::Method::POST,
        utoipa::openapi::HttpMethod::Put => axum::http::Method::PUT,
        utoipa::openapi::HttpMethod::Delete => axum::http::Method::DELETE,
        utoipa::openapi::HttpMethod::Options => axum::http::Method::OPTIONS,
        utoipa::openapi::HttpMethod::Head => axum::http::Method::HEAD,
        utoipa::openapi::HttpMethod::Patch => axum::http::Method::PATCH,
        utoipa::openapi::HttpMethod::Trace => axum::http::Method::TRACE,
    }
}

pub fn get_url_mappings() -> HashMap<(Method, String), String> {
    api_macros::url_mappings!(
        award::list,
        award::list_ids,
        award::create,
        award::retrieve_by_id,
