...
#[api_macros::docker_wrapper(path = "bollard::models::Volume")]
pub struct Volume {
...
#[api_macros::docker_wrapper(path = "bollard::models::VolumeUsageData")]
pub struct VolumeUsageData {
    pub size: i64,
    pub ref_count: i64,
}

#[api_macros::docker_wrapper(path = "bollard::models::VolumeScopeEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::volume::CreateVolumeOptions<String>")]
...
#[api_macros::docker_wrapper(path = "bollard::models::VolumePruneResponse")]
pub struct VolumePruneResponse {
    pub volumes_deleted: Option<Vec<String>>,
    pub space_reclaimed: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::volume::RemoveVolumeOptions")]
pub struct RemoveVolumeQuery {
    pub force: bool,
}

#[api_macros::docker_wrapper(path = "bollard::volume::PruneVolumesOptions<String>")]
pub struct PruneVolumesQuery {
    pub filters: HashMap<String, Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::volume::ListVolumesOptions<String>")]
pub struct ListVolumesQuery {
    pub filters: HashMap<String, Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolume")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeInfo")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumePublishStatus")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumePublishStatusStateEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpec")]
pub struct ClusterVolumeSpec {
    pub group: Option<String>,
    pub access_mode: Option<ClusterVolumeSpecAccessMode>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessMode")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessModeScopeEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessModeSharingEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessModeAvailabilityEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessModeAccessibilityRequirements")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessModeCapacityRange")]
pub struct ClusterVolumeSpecAccessModeCapacityRange {
    pub required_bytes: Option<i64>,
    pub limit_bytes: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ClusterVolumeSpecAccessModeSecrets")]
pub struct ClusterVolumeSpecAccessModeSecrets {
    pub key: Option<String>,
    pub secret: Option<String>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ObjectVersion")]
pub struct ObjectVersion {
    pub index: Option<u64>,
}

#[api_macros::docker_wrapper(path = "bollard::models::PortBinding")]
pub struct PortBinding {
    pub host_ip: Option<String>,
    pub host_port: Option<String>,
}

#[api_macros::docker_wrapper(path = "bollard::network::PruneNetworksOptions<String>")]
pub struct PruneNetworksQuery {
    filters: HashMap<String, Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::network::ListNetworksOptions<String>")]
pub struct ListNetworksQuery {
    filters: HashMap<String, Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::network::InspectNetworkOptions<String>")]
pub struct InspectNetworkQuery {
    pub verbose: bool,
    pub scope: String,
}

#[api_macros::docker_wrapper(path = "bollard::network::ConnectNetworkOptions<String>")]
pub struct ConnectNetworkBody {
    pub container: String,
    pub endpoint_config: EndpointSettings,
}

#[api_macros::docker_wrapper(path = "bollard::models::EndpointSettings")]
...
#[api_macros::docker_wrapper(path = "bollard::models::EndpointIpamConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::network::CreateNetworkOptions<String>")]
...
#[api_macros::docker_wrapper(path = "bollard::network::DisconnectNetworkOptions<String>")]
pub struct DisconnectNetworkBody {
    pub container: String,
    pub force: bool,
}

#[api_macros::docker_wrapper(path = "bollard::models::NetworkPruneResponse")]
pub struct NetworkPruneResponse {
    pub networks_deleted: Option<Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::NetworkCreateResponse")]
pub struct CreateNetworkResponse {
    pub id: String,
    pub warning: String,
}

#[api_macros::docker_wrapper(path = "bollard::models::Network")]
pub struct Network {
...
#[api_macros::docker_wrapper(path = "bollard::models::Ipam")]
pub struct Ipam {
    pub driver: Option<String>,
    pub options: Option<HashMap<String, String>>,
...
#[api_macros::docker_wrapper(path = "bollard::models::IpamConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ConfigReference")]
pub struct ConfigReference {
    pub network: Option<String>,
}

#[api_macros::docker_wrapper(path = "bollard::models::PeerInfo")]
pub struct PeerInfo {
    pub name: Option<String>,
    pub ip: Option<String>,
}

#[api_macros::docker_wrapper(path = "bollard::models::NetworkContainer")]
...
#[api_macros::docker_wrapper(path = "bollard::image::ListImagesOptions<String>")]
...
#[api_macros::docker_wrapper(path = "bollard::image::PruneImagesOptions<String>")]
pub struct PruneImagesQuery {
    pub filters: HashMap<String, Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::image::RemoveImageOptions")]
pub struct RemoveImageQuery {
    pub force: bool,
    pub noprune: bool,
}

#[api_macros::docker_wrapper(path = "bollard::image::TagImageOptions<String>")]
pub struct TagImageBody {
    pub repo: String,
    pub tag: String,
}

#[api_macros::docker_wrapper(path = "bollard::image::SearchImagesOptions<String>")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImagePruneResponse")]
pub struct ImagePruneResponse {
    pub images_deleted: Option<Vec<ImageDeleteResponseItem>>,
    pub space_reclaimed: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageDeleteResponseItem")]
pub struct ImageDeleteResponseItem {
    pub untagged: Option<String>,
    pub deleted: Option<String>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageInspect")]
...
#[api_macros::docker_wrapper(path = "bollard::models::DriverData")]
pub struct DriverData {
    pub name: String,
    pub data: HashMap<String, String>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageInspectMetadata")]
pub struct ImageInspectMetadata {
    pub last_tag_time: Option<chrono::DateTime<chrono::Utc>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageInspectRootFs")]
pub struct ImageInspectRootFs {
    pub typ: String,
    pub layers: Option<Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HealthConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImageSummary")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImageManifestSummary")]
...
#[api_macros::docker_wrapper(path = "bollard::models::OciDescriptor")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImageManifestSummaryKindEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImageManifestSummaryAttestationData")]
pub struct ImageManifestSummaryAttestationData {
    #[serde(rename = "for")]
    pub _for: String,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageManifestSummaryImageData")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImageManifestSummaryImageDataSize")]
pub struct ImageManifestSummaryImageDataSize {
    pub unpacked: i64,
}

#[api_macros::docker_wrapper(path = "bollard::models::ImageManifestSummarySize")]
pub struct ImageManifestSummarySize {
    pub total: i64,
    pub content: i64,
}

#[api_macros::docker_wrapper(path = "bollard::models::OciPlatform")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HistoryResponseItem")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ImageSearchResponseItem")]
...
impl BuildImageBody {
    pub fn to_push_options(&self) -> bollard::image::PushImageOptions<String> {
        bollard::image::PushImageOptions { tag: self.tag.clone() }
    }
...
#[api_macros::docker_wrapper(path = "bollard::container::ListContainersOptions<String>")]
...
#[api_macros::docker_wrapper(path = "bollard::container::PruneContainersOptions<String>")]
pub struct PruneContainersQuery {
    pub filters: HashMap<String, Vec<String>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ContainerPruneResponse")]
pub struct ContainerPruneResponse {
    pub containers_deleted: Option<Vec<String>>,
    pub space_reclaimed: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::container::CreateContainerOptions<String>")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ContainerCreateResponse")]
pub struct CreateContainerResponse {
    pub id: String,
    pub warnings: Vec<String>,
}

#[api_macros::docker_wrapper(path = "bollard::container::RemoveContainerOptions")]
...
#[api_macros::docker_wrapper(path = "bollard::container::InspectContainerOptions")]
pub struct InspectContainerQuery {
    pub size: bool,
}

#[api_macros::docker_wrapper(path = "bollard::container::KillContainerOptions<String>")]
pub struct KillContainerBody {
    pub signal: String,
}

#[api_macros::docker_wrapper(path = "bollard::container::StopContainerOptions")]
pub struct StopContainerBody {
    pub t: i64,
}

#[api_macros::docker_wrapper(path = "bollard::container::StartContainerOptions<String>")]
pub struct StartContainerBody {
    pub detach_keys: String,
}

#[api_macros::docker_wrapper(path = "bollard::models::ContainerSummary")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ContainerSummaryHostConfig")]
pub struct ContainerSummaryHostConfig {
    pub network_mode: Option<String>,
    pub annotations: Option<HashMap<String, String>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ContainerSummaryNetworkSettings")]
pub struct ContainerSummaryNetworkSettings {
    pub networks: Option<HashMap<String, EndpointSettings>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::Port")]
pub struct Port {
    pub ip: Option<String>,
...
#[api_macros::docker_wrapper(path = "bollard::models::PortTypeEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::MountPoint")]
...
#[api_macros::docker_wrapper(path = "bollard::models::MountPointTypeEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ContainerInspectResponse")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ContainerState")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ContainerStateStatusEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HostConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ContainerConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::models::NetworkSettings")]
...
#[api_macros::docker_wrapper(path = "bollard::models::Health")]
pub struct Health {
...
#[api_macros::docker_wrapper(path = "bollard::models::HealthStatusEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HealthcheckResult")]
...
#[api_macros::docker_wrapper(path = "bollard::models::Address")]
pub struct Address {
    pub addr: Option<String>,
    pub prefix_len: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ResourcesBlkioWeightDevice")]
pub struct ResourcesBlkioWeightDevice {
    pub path: Option<String>,
    pub weight: Option<usize>,
}

#[api_macros::docker_wrapper(path = "bollard::models::ThrottleDevice")]
pub struct ThrottleDevice {
    pub path: Option<String>,
    pub rate: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::models::DeviceMapping")]
...
#[api_macros::docker_wrapper(path = "bollard::models::DeviceRequest")]
...
#[api_macros::docker_wrapper(path = "bollard::models::ResourcesUlimits")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HostConfigLogConfig")]
...
#[api_macros::docker_wrapper(path = "bollard::models::RestartPolicy")]
pub struct RestartPolicy {
    pub name: Option<RestartPolicyNameEnum>,
    pub maximum_retry_count: Option<i64>,
}

#[api_macros::docker_wrapper(path = "bollard::models::RestartPolicyNameEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::Mount")]
pub struct Mount {
...
#[api_macros::docker_wrapper(path = "bollard::models::MountTypeEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::MountBindOptions")]
...
#[api_macros::docker_wrapper(path = "bollard::models::MountBindOptionsPropagationEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::MountVolumeOptions")]
...
#[api_macros::docker_wrapper(path = "bollard::models::MountVolumeOptionsDriverConfig")]
pub struct MountVolumeOptionsDriverConfig {
    pub name: Option<String>,
    pub options: Option<HashMap<String, String>>,
}

#[api_macros::docker_wrapper(path = "bollard::models::MountTmpfsOptions")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HostConfigCgroupnsModeEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::HostConfigIsolationEnum")]
...
#[api_macros::docker_wrapper(path = "bollard::models::FilesystemChange")]
...
#[api_macros::docker_wrapper(path = "bollard::container::RestartContainerOptions")]
pub struct RestartContainerBody {
    pub t: isize,
}

#[api_macros::docker_wrapper(path = "bollard::models::ContainerTopResponse")]
...
#[api_macros::docker_wrapper(path = "bollard::container::Stats")]
pub struct Stats {
...
#[api_macros::docker_wrapper(path = "bollard::container::MemoryStatsStatsV1")]
...
#[api_macros::docker_wrapper(path = "bollard::container::MemoryStatsStatsV2")]
...
#[api_macros::docker_wrapper(path = "bollard::container::MemoryStats")]
...
#[api_macros::docker_wrapper(path = "bollard::container::PidsStats")]
pub struct PidsStats {
    pub current: Option<u64>,
    pub limit: Option<u64>,
}

#[api_macros::docker_wrapper(path = "bollard::container::BlkioStats")]
...
#[api_macros::docker_wrapper(path = "bollard::container::StorageStats")]
...
#[api_macros::docker_wrapper(path = "bollard::container::NetworkStats")]
...
#[api_macros::docker_wrapper(path = "bollard::container::CPUStats")]
pub struct CPUStats {
...
#[api_macros::docker_wrapper(path = "bollard::container::BlkioStatsEntry")]
...
#[api_macros::docker_wrapper(path = "bollard::container::ThrottlingData")]
...
#[api_macros::docker_wrapper(path = "bollard::container::CPUUsage")]
pub struct CPUUsage {
