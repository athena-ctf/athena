...
#[openapi(
    ...
    paths(
        ...
        achievement::retrieve_relations_by_id,
        achievement::export,
        achievement::import,
        admin::list,
        admin::create,
        ...
        player_achievement::create,
        player_achievement::retrieve_by_id,
        player_achievement::update_by_id,
        player_achievement::delete_by_id,
        player_achievement::retrieve_relations_by_id,
        player_achievement::export,
        player_achievement::import,
        settings::retrieve,
        settings::update,
        stats::retrieve,
        submission::list,
