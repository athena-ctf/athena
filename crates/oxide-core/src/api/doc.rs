...
#[openapi(
    ...
    paths(
        ...
        challenge::list_deployments_by_id,
        ...
        deployment::retrieve_challenge_by_id,
        deployment::retrieve_player_by_id,
        deployment::list_instances_by_id,
        file::list,
        file::create,
        file::retrieve_by_id,
        file::update_by_id,
        ...
        instance::retrieve_deployment_by_id,
        invite::list,
        invite::create,
        ...
        player::retrieve_deployment_by_id,
