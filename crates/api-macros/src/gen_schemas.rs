...
pub fn gen_schemas_impl(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    match input {
        Item::Struct(input) => {
            ...
            let (struct_field, active_model_field, fn_struct_field, model_gen_fn, model_gen_method) = has_password
                .then_some((
            ...
            let struct_ident = format_ident!("{}IdSchema", heck::AsUpperCamelCase(&table_args.table_name).to_string());
            let model_ident = format_ident!("{}Model", heck::AsUpperCamelCase(&table_args.table_name).to_string());
        ...
        Item::Enum(input) => {
            ...
            quote! {
                ...
                impl sea_orm::IntoActiveValue<Self> for #ident {
