        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Invite::CreatedAt).timestamp_with_time_zone().not_null())
                    .col(ColumnDef::new(Invite::UpdatedAt).timestamp_with_time_zone().not_null())
                    .col(ColumnDef::new(Invite::Remaining).integer().not_null())
                    .col(ColumnDef::new(Invite::ExpiresAt).timestamp_with_time_zone().not_null())
